...
class CursorStyle {
  ...
  void setBold() => attrs |= CellAttr.bold;
  void setFaint() => attrs |= CellAttr.faint;
  void setItalic() => attrs |= CellAttr.italic;
  void setUnderline() => attrs |= CellAttr.underline;
  void setBlink() => attrs |= CellAttr.blink;
  void setInverse() => attrs |= CellAttr.inverse;
  void setInvisible() => attrs |= CellAttr.invisible;
  void setStrikethrough() => attrs |= CellAttr.strikethrough;

  void unsetBold() => attrs &= ~CellAttr.bold;
  void unsetFaint() => attrs &= ~CellAttr.faint;
  void unsetItalic() => attrs &= ~CellAttr.italic;
  void unsetUnderline() => attrs &= ~CellAttr.underline;
  void unsetBlink() => attrs &= ~CellAttr.blink;
  void unsetInverse() => attrs &= ~CellAttr.inverse;
  void unsetInvisible() => attrs &= ~CellAttr.invisible;
  ...
  void resetForegroundColor() => foreground = 0;

  void setBackgroundColor16(int color) => background = color | CellColor.named;
  void setBackgroundColor256(int color) =>
      background = color | CellColor.palette;
  void setBackgroundColorRgb(int r, int g, int b) =>
      background = (r << 16) | (g << 8) | b | CellColor.rgb;
  void resetBackgroundColor() => background = 0;
